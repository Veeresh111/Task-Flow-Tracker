...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Sign In Failed", description: "Could not sign in. Please check your credentials.", variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      toast({ title: "Reset Failed", description: "Could not send a reset link. Please try again.", variant: "destructive" });
    } finally {
