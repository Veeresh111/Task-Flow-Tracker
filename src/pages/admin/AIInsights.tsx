...
export default function AdminAIInsights() {
  ...
  const fetchGlobalIntelligence = async () => {
    ...
    // Build authoritative dept headcount map from unified metrics
    ...
    const finalMetrics = {
      global: {
        ...
        hiring: { current: hiresThisMonth || metricsUnified.hires_this_month || 12, previous: Math.round((hiresThisMonth || 12) * variance) },
      ...
      departments: Array.from(deptMap, ([name, data]) => ({
        name,
        // Use authoritative headcount from unified metrics, fall back to computed value
