...
export default function HRRecruitment() {
  ...
  // --- CORPORATE FIX: GLOBAL EXPONENTIAL BACKOFF FOR 429 & 503 ERRORS ---
    ...
    while (attempt < maxRetries) {
      try {
        ...
        if (msg.includes('429') || msg.includes('503') || msg.includes('Quota')) {
          ...
          toast({ title: "Network Busy", description: `Google API (429/503). Auto-retrying in ${attempt * 4}s...`, variant: "default" });
